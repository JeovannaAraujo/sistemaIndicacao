...
import 'package:myapp/Cliente/servicos_finalizados.dart';
...
void main() {
  ...
  Future<void> pumpServicosFinalizadosScreen(WidgetTester tester) async {
  ...
  Future<void> waitForLoaders(WidgetTester tester) async {
  ...
  testWidgets('📖 READ 1️⃣ Lista serviços finalizados do cliente logado', (tester) async {
    ...
    await pumpServicosFinalizadosScreen(tester);
    await waitForLoaders(tester);
