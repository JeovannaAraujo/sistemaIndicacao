              ...
              builder: (context, snap) {
                ...
                final docs = snap.data!.docs.where((doc) {
                  ...
                  final status = (d['status'] ?? 'pendente')
                      .toString()
                      .toLowerCase();
                  final recusadaEm = (d['recusadaEm'] as Timestamp?)?.toDate();
                  ...
                  // 🔹 MOSTRAR: Recusadas por 24 horas a partir da data da recusa
                  if (status == 'recusada') {
                    if (recusadaEm != null) {
                      final diff = now.difference(recusadaEm).inHours;
                      return diff <
                          24; // Mostra por 24 horas a partir da recusa
                    }
                    return false;
                  }
...
class CardEnviada extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final recusadaEm = (dados['recusadaEm'] as Timestamp?)?.toDate();
    final motivoRecusa = (dados['recusaMotivo'] ?? '').toString();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ====== AVISO DE RECUSA (ANTES DO BOTÃO) ======
          if (status == 'recusada' && recusadaEm != null) ...[
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    Icons.cancel_outlined, // Ícone igual ao exemplo
