...
class EditarPerfilPrestadorState extends State<EditarPerfilPrestador> {
  ...
  Future<void> _carregarPerfil() async {
    try {
      ...
      // CORREÇÃO: Se for string vazia, definir como null
      ...
      children: [
        ...
        StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, snap) {
            ...
            // CORREÇÃO: Verificar se o valor atual existe nos itens
            String? dropdownValue = categoriaProfId;
            if (dropdownValue != null) {
              final exists = items.any((item) => item.value == dropdownValue);
              if (!exists) {
                dropdownValue = null;
              }
            }
            ...
            return DropdownButtonFormField<String>(
              ...
              // CORREÇÃO: Adicionar hint quando não há valor selecionado
