...
class _CategProfState extends State<CategProf> {
  ...
  void initState() {
    super.initState();
    categoriasRef = (widget.firestore ?? FirebaseFirestore.instance).collection(
                ...
                onPressed: () async {
                  if (nomeCtrl.text.isNotEmpty && descCtrl.text.isNotEmpty) {
                    ...
                    try {
                      ...
                      // ✅ Correção: Verificar mounted antes de usar context
                      if (mounted) {
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.deepPurple.withAlpha(
              20,
            ), // ← Use withAlpha em vez de withOpacity
            blurRadius: 6,
      ...
      child: Row(
        children: [
          ...
          Switch(
            ...
            activeThumbColor: Colors.deepPurple, // ← Use activeThumbColor
            onChanged: (val) =>
